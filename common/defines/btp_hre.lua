...
NDefines.NCountry.MERCHANT_REPUBLIC_SIZE_LIMIT = 40			-- Beyond Typus added large number of new provinces make province number based things like this require updating base 20
...
NDefines.NMilitary.FORTRESS_COST = 0.25			-- Beyond Typus added all the new provinces mean more forts but no more dev so everyone was going broke Base 05